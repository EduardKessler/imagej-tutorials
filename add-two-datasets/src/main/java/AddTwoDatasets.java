 ...
 */
@Plugin(type = Command.class, headless = true, menuPath = "Tutorials>Add Two Datasets")
public class AddTwoDatasets implements Command, Previewable {
            ...
            final Dataset d1, final Dataset d2, final T outType)
	{
        ...
        IterableInterval<FloatType> float_img1 = opService.convert().float32(img1);
        IterableInterval<FloatType> float_img2 = opService.convert().float32(img2);
